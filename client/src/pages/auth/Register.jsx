    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" placeholder='Ethereum Wallet Address' autoComplete='off' className='form-control' id="ethereumWalletAddress" ref={ethereum_wallet_address} required/>
                </div>
                <div className="mb-3">
